...
This indicates that the compartmental neuron
...
The workhorse of the brain, pyramidal neurons,
...
it is also well known that the anatomical properties of pyramidal neurons, in particular
the dendritic structure, varies significantly across cortical regions 
...
basal dendritic tree \citep{Elston1997,Elston2000}, which can be associated to the
fact that neurons in higher cortical areas generally encode more complex or even
...
Apart from variations in the number of spines, variability can
also be observed within the dendritic structure itself 
